...
local opcodes = {
    ...
    [0xC0] = {
        ...
        func = function ()
            ...
            if addressMode.debug.trace then addressMode.OpcodePrint("CPY","CPY","0xC0", 0, value, 0, 0) end
    ...
    [0xC4] = {
        ...
        func = function ()
            ...
            OpcodeFunction(value)
            if addressMode.debug.trace then addressMode.OpcodePrint("CPY","CPY","0xC4", address, value, 0, 0) end
            return cycleCounts, pcCounts
        end
    },
    -- Absolute Mode
    [0xCC] = {
        ...
        func = function ()
            ...
            local value = bus.CPURead(address)
            OpcodeFunction(value)
            if addressMode.debug.trace then addressMode.OpcodePrint("CPY","CPY","0xCC", address, value, 0, 0) end
            return cycleCounts, pcCounts
        end
    },
